---
title: "Creando una tabla sobre tu artista favorito con {gt} y la API de Spotify"
...
```{r, echo=FALSE}
# Param para regenerar las tablas en el knit
# If knit_eval=FALSE, solo renderiza celdas de display de tablas, es un knit muy rápido. 
knit_eval = FALSE
```
...
Este post hace referencia al [taller del 2022-11-23](https://rladiesba.netlify.app/project/tablagt/):

🔸 [Repositorio](https://github.com/RLadies-BA/gt-spotify) 🔸 [Grabación](https://www.youtube.com/watch?v=wciGM5rMBos&ab_channel=RLadiesBuenosAires) 🔸

```{r, echo=FALSE}
knitr::include_url('https://karbartolome.github.io/gt-spotify/01_slides/rladies_gt_spotify.html')
```
...
Mediante la función **get_spotify_access_token**() del paquete {**spotifyr**} 📦, se realiza la autenticación a la API:
...
knitr::include_graphics('images/tabla_1.png')
```
...
```{r, echo=FALSE, eval=TRUE}
knitr::include_graphics('images/tabla_2.png')
```
...
```{r, echo=FALSE, eval=TRUE}
knitr::include_graphics('images/tabla_3.png')
```
...
```{r, echo=FALSE, eval=TRUE}
knitr::include_graphics('images/tabla_4.png')
```
...
```{r, echo=FALSE, eval=TRUE}
knitr::include_graphics('images/tabla_5.png')
```
...
```{r, echo=FALSE, eval=TRUE}
knitr::include_graphics('images/tabla_6.png')
```
...
```{r, echo=FALSE, eval=TRUE}
knitr::include_graphics('images/tabla_7.png')
```
...
```{r, eval=knit_eval, echo=FALSE}
ggplot2::ggsave('images/plot_1.png')
```
...
```{r, echo=FALSE, eval=TRUE}
knitr::include_graphics('images/tabla_8.png')
```
...
knitr::include_graphics('images/tabla_9.png')
```
...
```{r, echo=FALSE, eval=TRUE}
knitr::include_graphics('images/tabla_10.png')
```
